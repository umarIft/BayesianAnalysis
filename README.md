...
The directed acyclic graph, DAG, is depicted in the following figure. ![Fig](Images/DAGv1.png?raw=true "Directed acyclic graph: Internal attributes related to software bugs"|width=100)
